...
The SASS files are structured using the common 7-1 architecture. There 7 different folders to contain related SASS partials and one `index.scss` file where the partial files are imported along with Bootstrap.
